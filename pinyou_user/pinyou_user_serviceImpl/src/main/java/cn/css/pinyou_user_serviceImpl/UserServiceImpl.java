...
import cn.css.pinyou_mapper.TbUserMapper;
import cn.css.pinyou_pojo.domain.TbUser;
import cn.css.pinyou_pojo.domain.TbUserExample;
...
import cn.css.pinyou_common.HttpClient;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean checkSmsCode(String phone, String smsCode) {
        // 使用redis的hash结构来存取验证码，k-v分别是电话号码和验证码
