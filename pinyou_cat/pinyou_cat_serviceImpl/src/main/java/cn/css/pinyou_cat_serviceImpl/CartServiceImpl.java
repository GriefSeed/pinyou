package cn.css.pinyou_cat_serviceImpl;
...
public class CartServiceImpl implements CartService {
    ...
    public List<Cart> mergeCartList(List<Cart> cartList, List<Cart> cartList_session) {
        ...
        for (Cart cart : cartList_session) {
            for (TbOrderItem orderItem : cart.getOrderItemList()) {
                this.addGoodsToCartList(cartList, orderItem.getItemId(), orderItem.getNum());
            }
        }
        return cartList;
    }
    ...
    public List<Cart> addGoodsToCartList(List<Cart> cartList, Long itemId, Integer num) {
        ...
        //4、如果此商品对应的商家没有在购物车集合中：添加一个信息购物车对象
        if (cart == null) {
            cart = new Cart();
            ...
            //5、如果此商品对应的商家在购物车集合中，判断此商品是否在购物车明细列表中
            ...
            if (orderItem == null) {
                ...
                //5.2如果此商品在购物车明细列表中，添加商品的数量和修改总价格
