...
import cn.css.pinyou_content_service.ContentService;
import cn.css.pinyou_dto.PageResult;
import cn.css.pinyou_mapper.TbContentMapper;
import cn.css.pinyou_pojo.domain.TbContent;
import cn.css.pinyou_pojo.domain.TbContentExample;
import cn.css.pinyou_pojo.domain.TbContentExample.Criteria;
...
public class ContentServiceImpl implements ContentService {
    ...
    public List<TbContent> findContentByCategoryId(Long categoryId) {
        ...
        example.setOrderByClause("sort_order");//写的是数据表的字段名
