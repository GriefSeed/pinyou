...
<body class="hold-transition skin-red sidebar-mini"
      ng-app="pinyougou" ng-controller="pageController" ng-init="num=1;loadSku()">
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${itemCat1Name}</a>
					</li>
					<li>
						<a href="#">${itemCat2Name}</a>
					</li>

					<li class="active">${itemCat3Name}</li>
				</ul>
			</div>
			<!--product-info-->
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if (itemImages?size>0)>
								<span class="jqzoom"><img jqimg="${itemImages[0].url}" src="${itemImages[0].url}" width="400px" height="400px"/></span>
							</#if>
						</div>
						<!--下方的缩略图-->
